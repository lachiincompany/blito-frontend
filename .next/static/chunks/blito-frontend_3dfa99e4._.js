...
function HomePage() {
    ...
    /* ----------- جستجوی سفر مطابق API جدید ----------- */ const searchTrips = async ()=>{
        ...
        try {
            ...
            const results = Array.isArray(rawData) ? rawData : (_rawData_results = rawData.results) !== null && _rawData_results !== void 0 ? _rawData_results : [];
            setTrips(results);
            setSearched(true);
        } catch (error) {
    ...
    /* ------------------ UI ------------------ */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$blito$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
