...
"[project]/blito-frontend/app/login/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const [password, setPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$blito$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const handleLogin = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$blito$2d$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/accounts/api/v1/auth/login/', {
                phone,
                password
            }, {
                headers: {
            ...
            if (err.response) {
                ...
                else setError("خطا ".concat(err.response.status, ": ").concat(((_err_response_data = err.response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.detail) || 'مشکلی پیش آمده.'));
            } else if (err.request) {
                setError('ارتباط با سرور برقرار نشد. اینترنت/سرور را بررسی کنید.');
            } else {
                setError("خطای برنامه: ".concat(err.message));
            }
        } finally{
            setLoading(false);
        }
...
_s(LoginPage, "NeP0AhdtHCxCvJOjciQla/jsYhs=", false, function() {
    return [
...
//# sourceMappingURL=blito-frontend_6dc67f07._.js.map