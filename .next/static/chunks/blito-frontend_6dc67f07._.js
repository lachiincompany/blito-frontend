...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$blito$2d$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:9000/accounts/api/v1/auth/login/', {
                phone,
                password
            }, {
                headers: {
